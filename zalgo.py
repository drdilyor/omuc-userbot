# modified version of https://github.com/gregoryneal/zalgo
# to exclude characters that telegram disallows
import random

class zalgo():

    def __init__(self, numAccentsUp=(1,3), numAccentsDown=(1,3), numAccentsMiddle=(1,2), maxAccentsPerLetter=3):
        self.numAccentsUp = numAccentsUp
        self.numAccentsDown = numAccentsDown
        self.numAccentsMiddle = numAccentsMiddle
        self.maxAccentsPerLetter = maxAccentsPerLetter
        #downward going diacritics
        self.dd = ['̖',' ̗',' ̘',' ̙',' ̜',' ̝',' ̞',' ̟',' ̠',' ̤',' ̥',' ̦',' ̩',' ̪',' ̫',' ̬',' ̭',' ̮',' ̯',' ̰',' ̱',' ̲',' ̹',' ̺',' ̻',' ̼',' ͅ',' ͇',' ͈',' ͉',' ͍',' ͎',' ͓',' ͔',' ͕',' ͖',' ͙',' ͚',' ',]
        #upward diacritics
        self.du = [' ̍',' ̎',' ̄',' ̅',' ̑',' ̆',' ̐',' ͒',' ͗',' ͑',' ̇',' ̈',' ͂',' ̓',' ̈́',' ͊',' ͋',' ͌',' ̃',' ̂',' ̌',' ͐',' ́',' ̋',' ̏',' ̽',' ̉',' ͣ',' ͤ',' ͥ',' ͦ',' ͧ',' ͨ',' ͩ',' ͪ',' ͫ',' ͬ',' ͭ',' ͮ',' ͯ',' ̾',' ͛',' ͆',' ̚',]
